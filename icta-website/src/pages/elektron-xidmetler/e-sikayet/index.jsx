...
const breadcrumbItems = [
  ...
  { label: "E-Şikayət" }, // sonuncu səhifədir, linksizdir
];
...
export default function FotoQaleriya() {
  ...
  useEffect(() => {
    const result = getSectionData("Elektron xidmətlər", "E-Şikayət");
    if (result) {
      setData(result);
    }
  }, [getSectionData]);
      ...
      <div className=" gap-6 mt-5 border-t">
        <div className="mb-2">
          <h3 className="text-2xl mb-5 mt-5">
            E-Şikayət xidməti üzrə Abunəçi səhifəsindən istifadə
          </h3>
          <p>
