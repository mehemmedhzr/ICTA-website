...
const XidmetKeyfiyyeti = () => {
  ...
  return (
    <div>
      ...
      <h1 className="text-[18px] font-medium pt-5 mb-3">{data.name1}</h1>
      ...
      <h1 className="text-[18px] font-medium pt-10 mb-3">{data.name2}</h1>
...
export default XidmetKeyfiyyeti;
