...
const SaglamReqabet = () => {
  ...
  return (
    <div>
      ...
      <h1 className="text-[24px] font-medium pt-5">{data.name1}</h1>
      <p className="text-[#525865] mb-5 pt-2">{data.desc1}</p>
      <h1 className="text-[24px] font-medium pt-2">{data.name2}</h1>
      <p className="text-[#525865] mb-5 pt-2">{data.desc2}</p>
      <h1 className="text-[24px] font-medium pt-2 mb-3">{data.name3}</h1>
      <h1 className="text-[18px] font-medium pt-2 mb-5">{data.name4}</h1>
      {data.desc3.map((el, index) => (
                <div key={index} className="flex gap-3 pt-3 items-start">
