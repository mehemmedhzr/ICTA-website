  ...
  return (
    <div>
      ...
      <div className="text-sm py-2 border-b pb-8">
        ...
        <span className="text-gray-500">Haqqımızda</span>
        <span className="mx-2 text-gray-500">›</span>
      ...
      <div>
        <div className="flex items-center gap-5">
          <img src={"/images/aztelekom.png"} alt="" className="w-[40px] pt-4" />
          <h1 className="text-[24px] font-medium pt-8 pb-3">{data.name2}</h1>
        </div>
        <p className="text-[#525865] mb-4">{data.desc2}</p>
      </div>
      <div>
        <h1 className="text-[24px] font-medium pt-8 pb-3">{data.name3}</h1>
